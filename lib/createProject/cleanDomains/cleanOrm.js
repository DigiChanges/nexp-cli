...
export default DatabaseFactory;
    ...
    await writeFile(resolve(`${vars.projectName}/src/Shared/Factories/DatabaseFactory.ts`), ormFactoryFile, { flag: 'w' });
};
...
const cleanOrm = async(vars, ormMapper) =>
{
    ...
    {
        const ormFiles = await glob(resolve(`${vars.projectName}/src/**/*${orm}*.ts`));
